...
(() => {
  ...
  if ("serviceWorker" in navigator) {
    ...
    navigator.serviceWorker
      ...
      .catch((res) => {
        console.log("Can not find service worker.");
      });
  }

  const q = (selector: string, target?: any) =>
    (target || document).querySelector(selector);
  const qa = (selector: string, target?: any) =>
    ...
    sideBar() {
      ...
      if (generalWrapper) {
        ...
        let calc = () => {
          ...
          if (rect.top <= 80) {
            Page.setStyleAttribute(sideBar, {
              position: "fixed",
              left: "0",
              top: "80px",
            });
            Page.setStyleAttribute(wrapperSections, {
              "margin-left": "auto",
          ...
          if (rect.top >= 80) {
            ...
            Page.setStyleAttribute(generalWrapper, {
    ...
    Blog: {
      ...
      init: function () {
        ...
        if (this.el) {
          ...
          this.pagination = new pl.Pagination(
            1,
            numPosts,
            ["image", "intro", "main-image", "modal"],
            ["creation-date"]
          );
      ...
      reachBottom: function (ev) {
        let scrollHeight = $(document).height() || 0;
        let scrollPosition =
  ...
  function initForm(formEl) {
        ...
        setTimeout(function () {
          ...
          if (Classie.hasClass(form.element, "ebook-form")) {
            ...
            download.setAttribute(
              "href",
              "/fragment/themes/cyborgconsulting/ebook.pdf"
            );
    ...
    form.success.add((response, status, statusText) =>
      handleSuccess(form, response, status, statusText)
    );
  }
  ...
  if (rpaRobots) {
    ...
    demoBtn.addEventListener("click", (e) => {
      ...
      const headHeight = $(".navigation").outerHeight() || 0;
      $("html, body").animate(
        {
