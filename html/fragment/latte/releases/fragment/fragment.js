...
(function (latte) {
    class pageBase extends latte.DataRecord {
        ...
        **/
        onGetFieldTypes() { return { 'idpage': 'number', 'idparent': 'number', 'idgroup': 'number', 'iduser': 'number', 'guid': 'string', 'key': 'string', 'trash': 'boolean', 'online': 'boolean', 'template': 'string', 'created': 'DateTime', 'modified': 'DateTime', 'title': 'string', 'description': 'string', 'order': 'number', 'sort': 'string', 'powner': 'number', 'pgroup': 'number', 'pother': 'number', 'pworld': 'number', 'flags': 'number' }; }
        /*
         * Remote Method.
 ...
 Sends the page to trash
    ...
    **/
    ...
    class fileBase extends latte.DataRecord {
        ...
        * Override. Gets data about the type of fields of the record.
        **/
        onGetFieldTypes() { return { 'idfile': 'number', 'guid': 'string', 'iduser': 'number', 'idowner': 'number', 'idparent': 'number', 'owner': 'string', 'name': 'string', 'size': 'number', 'bucket': 'string', 'path': 'string', 'uploaded': 'DateTime', 'description': 'string', 'width': 'number', 'height': 'number', 'key': 'string' }; }
        /*
         * Remote Method.
 ...
 Removes the registry of file and its contents from S3.
    ...
    **/
    ...
    class settingBase extends latte.DataRecord {
        ...
        * Override. Gets data about the type of fields of the record.
        **/
        onGetFieldTypes() { return { 'idsetting': 'number', 'idowner': 'number', 'owner': 'string', 'name': 'string', 'value': 'string' }; }
        /*
         * Remote Method.
 Search pageTag method
         ...
         */
        static byOwnerAndText(owner, text) {
            return new latte.RemoteCall('fragment', 'Setting', 'byOwnerAndText', { owner: owner, text: text });
        }
        /*
         * Remote Method.

         */
        static byOwnerOnly(owner, id) {
            return new latte.RemoteCall('fragment', 'Setting', 'byOwnerOnly', { owner: owner, id: id });
        }
        /*
         * Remote Method.
 Creates the pageTag for the specified record
         ...
         */
        static create(owner, id, value) {
            return new latte.RemoteCall('fragment', 'Setting', 'create', { owner: owner, id: id, value: value });
        }
        /*
         * Remote Method.
 ...
 Gets the global setting by name. Only for root users
    ...
    **/
    ...
    class fragmentBase extends latte.DataRecord {
        ...
        * Override. Gets data about the type of fields of the record.
        **/
        onGetFieldTypes() { return { 'idfragment': 'number', 'idpage': 'number', 'value': 'string', 'name': 'string' }; }
    }
    /**
    * Declares the native types of the record.
    **/
    ...
    class groupBase extends latte.DataRecord {
        ...
        * Override. Gets data about the type of fields of the record.
        **/
        onGetFieldTypes() { return { 'idgroup': 'number', 'name': 'string' }; }
        /*
         * Remote Method.
    ...
    **/
    ...
    class groupUserBase extends latte.DataRecord {
        ...
        * Override. Gets data about the type of fields of the record.
        **/
        onGetFieldTypes() { return { 'idgroupuser': 'number', 'idgroup': 'number', 'iduser': 'number' }; }
        /*
         * Remote Method.
    ...
    **/
    ...
    class userBase extends latte.DataRecord {
        ...
        * Override. Gets data about the type of fields of the record.
        **/
        onGetFieldTypes() { return { 'iduser': 'number', 'uname': 'string', 'password': 'string', 'flags': 'number' }; }
        /*
         * Remote Method.
...
(function (latte) {
     ...
     */
    class TagValueItem extends latte.ValueItem {
        /**
        ...
        updateList() {
            ...
            this.onLoadItems((items) => {
                if (latte._isArray(items) && items.length > 0) {
                    items.forEach((item) => {
                        this.onAddItem(item);
                    });
                }
                else {
                    let label = new latte.LabelItem(strings.nothingToShow);
         ...
         * @param record
         */
        onCreateItem(record = null) {
            throw new latte.Ex("Not implemented");
        }
        /**
         * Filter Suggestions
         */
        ...
        get itemCreated() {
            if (!this._itemCreated) {
                this._itemCreated = new latte.LatteEvent(this);
            }
        ...
        get itemTrashed() {
            if (!this._itemTrashed) {
                this._itemTrashed = new latte.LatteEvent(this);
            }
    ...
    latte.TagValueItem = TagValueItem;
})(latte || (latte = {}));
/**
...
(function (latte) {
    ...
    class PageExplorer extends latte.ExplorerItemDataRecord {
        ...
        getColumnHeaders() {
            return [
                new latte.ColumnHeader(strings.title, 250),
                new latte.ColumnHeader(strings.pageKey),
                new latte.ColumnHeader(strings.guid, 90)
            ];
        }
        /**
         * Gets the columns of the item
...
(function (latte) {
    ...
    })(ImageFit = latte.ImageFit || (latte.ImageFit = {}));
    /**
     *
     */
    class ImageUtil {
...
(function (latte) {
    ...
    class ImageFragmentAdapter extends latte.FragmentAdapter {
        ...
        viewOriginal() {
            latte.ImageEditorView.QUALITY = this.fragmentConfiguration['image-quality'];
         ...
         */
        btnImageAltText_Click() {
            //let pic = file.getChildByKey(ImageFragmentAdapter.PRESENTABLE_KEY);
            let file = this.presentableFile;
            if (this.presentableFile) {
                let dlg = new latte.DialogView();
                let frm = new latte.FormView();
                let alt = new latte.InputItem();
        ...
        get btnImageAltText() {
            if (!this._btnImageAltText) {
                let lazy = this._btnImageAltText = new latte.ButtonItem();
                lazy.icon = latte.LinearIcon.lock;
...
(function (latte) {
    ...
    class ImageGalleryFragmentAdapter extends latte.FragmentAdapter {
        ...
        btnImageAltText_Click() {
            if (this.selectedFile) {
                ...
                if (pic != null) {
                    ...
                    let frm = new latte.FormView();
                    let alt = new latte.InputItem();
                    let desc = new latte.InputItem();
                    alt.valueItem.placeholder = strings.altText;
                    desc.valueItem.placeholder = strings.descText;
                    let imageData = JSON.parse(file.description || JSON.stringify(this.getDetaultImageDescription()));
        ...
        btnImageSetSize_Click() {
            if (this.selectedFile) {
                ...
                if (pic != null) {
                    let dlg = new latte.DialogView();
                    let frm = new latte.FormView();
                    let txtHeight = new latte.InputItem('', 'number');
                    let txtWidth = new latte.InputItem('', 'number');
                    txtHeight.valueItem.placeholder = strings.heightPr;
                    txtWidth.valueItem.placeholder = strings.widthPr;
                    ...
                    txtWidth.valueItem.sideLabel.text = '%';
                    txtHeight.valueItem.sideLabel.text = '%';
        ...
        serialize() {
            ...
            this.files.each((f) => {
                ...
                if (!thumb || !presentable)
                    return;
                let imageData = JSON.parse(f.file.description || JSON.stringify(this.getDetaultImageDescription()));
                let img = document.createElement('img');
        ...
        get btnImageAltText() {
            if (!this._btnImageAltText) {
                let lazy = this._btnImageAltText = new latte.ButtonItem();
                lazy.icon = latte.LinearIcon.text_format;
                lazy.text = strings.altText;
                lazy.tab = this.tabImage;
                lazy.click.add(this.btnImageAltText_Click, this);
            }
        ...
        get btnImageSetSize() {
            if (!this._btnImageSetSize) {
                const lazy = this._btnImageSetSize = new latte.ButtonItem();
                //lazy
                lazy.icon = latte.LinearIcon.picture;
...
(function (latte) {
    ...
    class File extends latte.fileBase {
            ...
            latte.Setting.getGlobalBuffered('image-quality', (setting) => {
                ...
                latte.ImageUtil.createThumbOfUrl(this.url, options, (data) => {
                    ...
                    img.addEventListener('load', () => {
                        let fu = latte.FileUploader.fromBase64(latte.ImageUtil.getBase64(data), this.name, "File", String(this.idfile));
                        fu.complete.add(() => {
                            // File uploaded!
         ...
         **/
        get url() {
            if (this.bucket && this.bucket.length > 5) {
                latte.log(this);
...
(function (latte) {
    ...
    })(ImageZoomMode = latte.ImageZoomMode || (latte.ImageZoomMode = {}));
    /**
    ...
    class ImageEditorView extends latte.ToolbarView {
        ...
        cropNow() {
            ...
            this.image = latte.ImageUtil.cropImage(this.image, this.cropBounds, options);
...
(function (latte) {
    ...
    class PageDetailView extends latte.ColumnView {
        ...
        get tagsForm() {
            if (!this._tagsForm) {
                let lazy = this._tagsForm = new latte.PageTagsForm();
                lazy.direction = latte.Direction.VERTICAL;
                lazy.visible = false;
            }
...
(function (latte) {
     ...
     * PageTagsForm
     */
    class PageTagsForm extends latte.FormItem {
        //region Static
        //endregion
        //region Fields
        //endregion
        ...
        get inputItem() {
            if (!this._inputItem) {
                this._inputItem = new latte.InputItem(strings.tag, 'string');
        ...
        get pageTagItem() {
            if (!this._pageTagItem) {
                const lazy = this._pageTagItem = new latte.SettingValueItem();
            }
    ...
    latte.PageTagsForm = PageTagsForm;
})(latte || (latte = {}));
/**
 * Created by josemanuel on 7/14/16.
 */
...
(function (latte) {
     ...
     */
    class SettingValueItem extends latte.TagValueItem {
        /**
         ...
         * @param setting
         */
        onCreateItem(setting = null) {
            let text = String(this.text).trim();
            console.log(text);
            // Call server method
            latte.Setting.create('PageTag', this.record.recordId, text).send((setting) => {
                if (setting instanceof latte.Setting) {
                    this.onItemCreated();
                }
            });
        }
        ...
        onFilterSuggestions() {
            ...
            latte.Setting.byOwnerAndText('PageTag', text).send((records) => {
                // Adds
                let items = [];
                records.forEach((setting) => {
                    let b = new latte.ButtonItem(setting.value, null, () => {
                ...
                // Separator
                if (records.length) {
                    items.push(new latte.SeparatorItem());
                }
         ...
         */
        onAddItem(record) {
            let item = new latte.ButtonItem();
            item.removeClass('clickable').addClass('tag-item');
            item.icon = latte.LinearIcon.cross;
        ...
        onLoadItems(callback) {
            // Vars
            let recordId = this.record.recordId;
            // Call server method
            latte.Setting.byOwnerOnly('PageTag', recordId).send((data) => {
                callback(data);
            });
        }
    }
    latte.SettingValueItem = SettingValueItem;
})(latte || (latte = {}));
/**
...
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/support/ts-include/datalatte.d.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/support/ts-include/fragment.strings.d.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/support/ts-include/jquery.d.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/support/ts-include/latte.d.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/support/ts-include/latte.data.d.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/support/ts-include/latte.data.strings.d.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/support/ts-include/latte.data.ui.d.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/support/ts-include/latte.element.d.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/support/ts-include/latte.strings.d.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/support/ts-include/latte.ui.d.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/support/ts-include/latte.ui.strings.d.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/support/ts-include/records.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/support/ts-include/views.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/support/ts-include/views_bank.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/fragment.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/interfaces/IFragment.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/interfaces/IFragments.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/interfaces/IGlobalConfigSetting.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/interfaces/IGlobalConfigurationSettings.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/interfaces/IImageDescription.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/interfaces/IImageFragment.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/interfaces/IPageConfiguration.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/interfaces/IImageGalleryFragment.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/interfaces/IPageSettingsPack.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/interfaces/IPageConfigurationSettings.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/interfaces/IPageConfigurationSetting.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/interfaces/IPageConfigurationChildren.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/ts-declarations/object-assign.d.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/helpers/FragmentAdapter.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/helpers/Uploader.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/views/TagValueItem.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/Main.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/UaEvents.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/explorers/GlobalSettingExplorer.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/explorers/GlobalSettingsExplorer.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/explorers/GroupExplorer.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/explorers/GroupUserExplorer.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/explorers/GroupsExplorer.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/explorers/PageExplorer.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/explorers/PagesExplorer.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/explorers/UserExplorer.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/explorers/UsersExplorer.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/helpers/FileReplacer.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/helpers/FileUploader.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/helpers/FragmentAdapterManager.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/helpers/ImageLoader.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/helpers/ImageUtil.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/helpers/Plugin.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/helpers/PageConfiguration.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/helpers/PluginManager.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/helpers/adapters/HtmlFragmentAdapter.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/helpers/adapters/ImageFragmentAdapter.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/helpers/adapters/ImageGalleryFragmentAdapter.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/helpers/adapters/PlainTextFragmentAdapter.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/items/FragmentExpandoItem.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/items/FileItem.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/items/LinearIcon.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/items/FragmentPlaceholderItem.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/records/Fragment.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/records/Group.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/records/GroupUser.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/records/File.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/records/Setting.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/records/Page.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/records/User.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/views/CmsExplorer.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/views/CmsMainView.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/views/GlobalSettingView.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/views/ImageEditorView.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/views/PageConfigurationView.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/views/PageAdvancedView.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/views/InstallWizardView.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/views/PageDetailView.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/views/PageTagsForm.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/views/PageSidebar.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/views/PageEditorView.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/views/SettingValueItem.ts" />
/// <reference path="/Users/developergoplek/Downloads/Fragment-master/latte/fragment/ts/views/SignInView.ts" />
